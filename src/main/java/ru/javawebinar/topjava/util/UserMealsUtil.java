...
public class UserMealsUtil {
    public static void main(String[] args) {
        List<UserMeal> mealList = Arrays.asList(
                ...
                new UserMeal(LocalDateTime.of(2015, Month.MAY, 29, 11, 0), "Завтрак", 600),
                new UserMeal(LocalDateTime.of(2015, Month.MAY, 30, 20, 0), "Ужин", 500),
                new UserMeal(LocalDateTime.of(2015, Month.MAY, 31, 10, 0), "Завтрак", 1000),
                new UserMeal(LocalDateTime.of(2015, Month.MAY, 31, 13, 0), "Обед", 500),
                new UserMeal(LocalDateTime.of(2015, Month.MAY, 31, 20, 0), "Ужин", 510),
                new UserMeal(LocalDateTime.of(2015, Month.MAY, 29, 19, 0), "Ужин", 540)
        );
        getFilteredWithExceeded(mealList, LocalTime.of(7, 0), LocalTime.of(19, 0), 2000);
    }
    ...
    public static List<UserMealWithExceed> getFilteredWithExceeded(List<UserMeal> mealList,
        ...
        return mealList.stream()
                ...
                .map(userMeal -> createWithExceed(userMeal,
